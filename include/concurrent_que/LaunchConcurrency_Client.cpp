...
{
    class Global_ConcurrentQue_Client* LaunchConcurrency_Client::ptr_Global = NULL;
    class LaunchConcurrency_Control_Client* LaunchConcurrency_Client::ptr_LaunchConcurrency_Control = NULL;

    LaunchConcurrency_Client::LaunchConcurrency_Client()
    {
        ptr_Global = new class Global_ConcurrentQue_Client();
    ...
    void LaunchConcurrency_Client::Thread_Start(unsigned char concurrent_CoreId)
    {
        class ConcurrentQue::LaunchConcurrency_Control_Client* ptr_LaunchConcurrency_Control = ConcurrentQue::Framework_ConcurrentQue_Client::Get_LaunchConcurrency()->Get_Control_Of_LaunchConcurrency();
        class ConcurrentQue::Global_ConcurrentQue_Client* ptr_Global = ConcurrentQue::Framework_ConcurrentQue_Client::Get_LaunchConcurrency()->Get_GlobalForLaunchConcurrency();
    ...
    void LaunchConcurrency_Client::Initialise_Control(
        class ConcurrentQue::Global_ConcurrentQue_Client* ptr_Global,
        unsigned char ptr_MyNumImplementedCores
    )
    {
        ptr_LaunchConcurrency_Control = new class ConcurrentQue::LaunchConcurrency_Control_Client(ptr_Global, ptr_MyNumImplementedCores);
        while (ptr_LaunchConcurrency_Control == NULL) { /* wait untill created */ }
    }

    void LaunchConcurrency_Client::Thread_End(unsigned char concurrent_CoreId)
    {
        class ConcurrentQue::LaunchConcurrency_Control_Client* ptr_LaunchConcurrency_Control = ConcurrentQue::Framework_ConcurrentQue_Client::Get_LaunchConcurrency()->Get_Control_Of_LaunchConcurrency();
        class ConcurrentQue::Global_ConcurrentQue_Client* ptr_Global = ConcurrentQue::Framework_ConcurrentQue_Client::Get_LaunchConcurrency()->Get_GlobalForLaunchConcurrency();
    ...
    class LaunchConcurrency_Control_Client* LaunchConcurrency_Client::Get_Control_Of_LaunchConcurrency()
    {
        return ptr_LaunchConcurrency_Control;
    }

    Global_ConcurrentQue_Client* LaunchConcurrency_Client::Get_GlobalForLaunchConcurrency()
    {
        return ptr_Global;
    }
}